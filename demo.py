...
if __name__ == "__main__":
    ...
    loaded_dict_enc = torch.load('depth/models/depth_face_model_Voxceleb2_10w/encoder.pth')
    loaded_dict_dec = torch.load('depth/models/depth_face_model_Voxceleb2_10w/depth.pth')
